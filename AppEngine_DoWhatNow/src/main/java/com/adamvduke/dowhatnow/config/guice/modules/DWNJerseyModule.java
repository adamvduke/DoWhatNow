...
public class DWNJerseyModule extends JerseyServletModule {
	...
	public void configureServlets() {
		...
		filtersBuilder.append( "com.adamvduke.appengine.common.filter.RequestLengthFilter" ).append( ";" );
		filtersBuilder.append( "com.adamvduke.appengine.common.filter.OAuthFilter" );
